...
public class FmsClient {
    ...
    private String get_aes_token() throws Exception {
        ...
        System.out.println("---------");
        System.out.println("BlockSize:    "+c.getBlockSize());package direct.thither.lib.api.fms;
/*
 * Author Kashirin Alex (kashirin.alex@gmail.com)
 * THITHER.DIRECT
 * */
...
public class FmsClient {
    ...
    private String get_aes_token() throws Exception {
        ...
        System.out.println("nonce b64:    "+new String(Base64.getEncoder().encode(nonce)));
        System.out.println("Input:        "+(new String(d)));
        System.out.println("Input len:    "+d.length);package direct.thither.lib.api.fms;
/*
 * Author Kashirin Alex (kashirin.alex@gmail.com)
 * THITHER.DIRECT
 * */
